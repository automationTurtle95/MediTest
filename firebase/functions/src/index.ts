...
const currentAppVersion = defineString("CURRENT_APP_VERSION", { default: "5.0.11" });
const windowsDownloadUrl = defineString("WINDOWS_DOWNLOAD_URL", {
  default: "https://github.com/automationTurtle95/MediTest/releases/download/v5.0.11/MediTest-Setup-5.0.11-win-x64.msi"
});
const macosArm64DownloadUrl = defineString("MACOS_ARM64_DOWNLOAD_URL", {
  default: "https://github.com/automationTurtle95/MediTest/releases/download/v5.0.11/MediTest-Setup-5.0.11-macos-arm64.dmg"
});
const macosX64DownloadUrl = defineString("MACOS_X64_DOWNLOAD_URL", {
  default: "https://github.com/automationTurtle95/MediTest/releases/download/v5.0.11/MediTest-Setup-5.0.11-macos-x64.dmg"
});
