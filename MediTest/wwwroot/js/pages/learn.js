      ...
      let exitHref = '/index.html'; // Ziel nach manuellem Beenden
      ...
      async function loadCards() {
        ...
        exitHref = weakMode ? '/pages/stats.html' : docId ? '/pages/documents.html' : '/index.html';
      ...
      function exitLearnMode() {
        ...
        const hasProgress = answered > 0 || revealed;
        if (
          hasProgress &&
          !confirm('Lernmodus wirklich beenden? Dein Fortschritt in dieser Kartenrunde wird nicht gespeichert.')
        ) {
          return;
        }
      ...
      document.getElementById('exitLearnBtn').onclick = exitLearnMode;
