...
internal static class AppSupport
{
    ...
    public static void CloseManagedBrowser(Process? browserProcess)
    {
    ...
    public static void CloseOtherMediTestInstances()
    {
    ...
    public static string SingleInstanceName()
    {
    ...
    public static bool AllowedFile(IFormFile file)
    {
        var ext = Path.GetExtension(file.FileName).ToLowerInvariant();
        return ext is ".pdf" or ".pptx" or ".txt";
    }

    public static bool IsPublicRequest(HttpContext context)
    {
    ...
    public static bool RequiresLicenseGate(HttpContext context)
    {
    ...
    public static string FirebaseProjectId(IConfiguration cfg)
    {
        return (cfg["Auth:Firebase:ProjectId"] ?? string.Empty).Trim();
    }

    public static AuthConfigDto ToAuthConfigDto(IConfiguration cfg)
    {
    ...
    public static FirebaseConfigDto? ToFirebaseConfigDto(IConfiguration cfg)
    {
    ...
    public static AuthUserDto ToFirebaseUserDto(ClaimsPrincipal principal, IConfiguration cfg)
    {
    ...
    public static bool FirebaseEmailVerified(ClaimsPrincipal principal)
    {
        return IsTruthy(FirstClaim(principal, "email_verified", "emailVerified"));
    }

    public static string FirstClaim(ClaimsPrincipal principal, params string[] names)
    {
    ...
    public static string FirebaseBearerToken(HttpContext context)
    {
    ...
    public static bool UserCanPublishCatalog(HttpContext context, IConfiguration cfg)
    {
    ...
    public static string CurrentUpdatePlatform()
    {
    ...
    public static string UpdateManifestUrl(IConfiguration cfg)
    {
    ...
    public static async Task<UpdateCheckDto> CheckForUpdateAsync(IConfiguration cfg, IHttpClientFactory httpClientFactory, CancellationToken ct)
    {
    ...
    public static UpdateManifest ParseUpdateManifest(JsonElement root)
    {
    ...
    public static UpdateDownloadDto ParseDownload(string platform, JsonElement element)
    {
    ...
    public static string PlatformFromFileName(string fileName)
    {
    ...
    public static string JsonText(JsonElement element, string propertyName)
    {
    ...
    public static long JsonLong(JsonElement element, string propertyName)
    {
    ...
    public static List<int> VersionParts(string value)
    {
    ...
    // ── Settings / License DTOs ────────────────────────────────────────────────

    public static bool ApplyFixedAiSettings(ProgramSettings settings)
    {
        var changed = false;
    ...
    public static ProgramSettingsDto ToProgramSettingsDto(ProgramSettings settings)
    {
    ...
    public static LicenseStatusDto ToLicenseStatusDto(UserLicenseState state, HttpContext context, IConfiguration cfg)
    {
    ...
    public static string CatalogCategory(string? category)
    {
        category = (category ?? string.Empty).Trim();
        return category.Equals("MedAT", StringComparison.OrdinalIgnoreCase) ? "MedAT" : "Allgemein";
    }

    public static string CatalogFolderPath(string category, string? folderPath, string? topic)
    {
    ...
    public static string DocumentFolderPath(string? folderPath)
    {
    ...
    public static int NormalizeQuestionCount(int value, int fallback)
    {
        return Math.Clamp(value <= 0 ? fallback : value, 1, 100);
    }

    public static string? ValidateQuestionImage(string? imageDataUrl)
    {
    ...
    public static string NormalizePremiumCode(string? code)
    {
        return Regex.Replace((code ?? string.Empty).Trim().ToUpperInvariant(), "[^A-Z0-9]", string.Empty);
    }

    public static string? EmptyDash(string? value) => string.IsNullOrWhiteSpace(value) ? "-" : value.Trim();
    ...
    public static string CsvEsc(string? value)
    {
    ...
    public static IResult CsvResult(StringBuilder csv, string filename)
    {
    ...
    public static string BillingCurrency(IConfiguration cfg) => string.IsNullOrWhiteSpace(cfg["Billing:Currency"]) ? CommercialPricing.Currency : cfg["Billing:Currency"]!.Trim().ToUpperInvariant();
    public static bool BillingEnforcesCatalogPurchases(IConfiguration cfg) => cfg.GetValue<bool?>("Billing:EnforceCatalogPurchases") ?? true;

    public static bool FreeCatalogCreditAvailable(UserLicenseState state)
    {
        return state.FreeCatalogCreditActive && string.IsNullOrWhiteSpace(state.FreeCatalogCreditRedeemedCatalogId);
    }

    // ── Firebase Function helpers ──────────────────────────────────────────────

    public static string FirebaseFunctionUrl(IConfiguration cfg, string configKey, string functionName)
    {
    ...
    public static CheckoutLinkDto ParseCheckoutLink(JsonDocument? json, string fallbackMessage)
    {
    ...
    public static async Task<(JsonDocument? Json, IResult? Error)> SendProtectedFirebaseFunctionAsync(
    ...
    public static string FirebaseFunctionError(string raw, string fallback)
    {
        try
        {
    ...
    public static async Task<(JsonDocument? Json, IResult? Error)> SendFirestoreAsync(
        HttpClient client,
        IConfiguration cfg,
        HttpContext context,
        HttpMethod method,
    ...
    public static async Task<IResult> FirestoreErrorResultAsync(HttpResponseMessage response, string fallback, CancellationToken ct)
    {
        var raw = await response.Content.ReadAsStringAsync(ct);
    ...
    public static string FirestoreErrorMessage(string raw)
    {
    ...
    public static string FirestoreDocumentId(JsonElement document)
    {
    ...
    public static string FirestoreString(JsonElement fields, string fieldName)
    {
    ...
    public static int FirestoreInt(JsonElement fields, string fieldName)
    {
    ...
    public static bool FirestoreBool(JsonElement fields, string fieldName, bool fallback = false)
    {
    ...
    public static DateTime? FirestoreTimestamp(JsonElement fields, string fieldName)
    {
    ...
    public static object FirestoreValue(string? value) => new Dictionary<string, object>
    {
        ["stringValue"] = value ?? string.Empty
    };

    public static object FirestoreIntValue(int value) => new Dictionary<string, object>
    {
        ["integerValue"] = value.ToString(CultureInfo.InvariantCulture)
    };

    public static object FirestoreBoolValue(bool value) => new Dictionary<string, object>
    {
        ["booleanValue"] = value
    };

    public static object FirestoreTimestampValue(DateTime value) => new Dictionary<string, object>
    {
    ...
    public static string[] CatalogCollections() => ["catalogTests", "thematicTests"];

    public static List<CatalogQuestionPayload> BuildCatalogQuestions(UploadedDocument doc)
    {
    ...
    public static List<CatalogQuestionPayload> DeserializeCatalogQuestions(string questionsJson)
    {
        if (string.IsNullOrWhiteSpace(questionsJson)) return [];

        try
        {
            var parsed = System.Text.Json.JsonSerializer.Deserialize<List<CatalogQuestionPayload>>(questionsJson, new System.Text.Json.JsonSerializerOptions(System.Text.Json.JsonSerializerDefaults.Web));
    ...
    // ── Question parsing / import ──────────────────────────────────────────────

    public static List<(string Question, List<string> Options, int Correct, string Explanation, string Topic, string Difficulty)> ParseImportedQuestions(string content)
    {
    ...
    public static byte[] BuildTestPdf(TestSession session, ProgramSettings settings)
    {
        ...
        foreach (var answer in orderedAnswers)
        {
            ...
            var optionIds = System.Text.Json.JsonSerializer.Deserialize<List<int>>(answer.ShuffledOptionIdsJson) ?? [];
...
// ── Support types (used by AppSupport and endpoints) ──────────────────────────
