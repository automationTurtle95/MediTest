...
Version 5.0.6 wird als Windows-MSI, Windows-Portable-ZIP und zwei signierte, von Apple notarisierte macOS-DMGs veröffentlicht.
...
```text
MediTest-Setup-5.0.6-win-x64.msi
MediTest-5.0.6-win-x64-portable.zip
...
```powershell
Get-ChildItem .\dist\MediTest-5.0.6 -Recurse -File |
