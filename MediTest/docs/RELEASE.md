...
Version 5.0.5 wird als Windows-MSI, Windows-Portable-ZIP und zwei signierte, von Apple notarisierte macOS-DMGs veröffentlicht.
...
```powershell
Get-ChildItem .\dist\MediTest-5.0.5 -Recurse -File |
