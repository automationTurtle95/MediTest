...
2. nur den Zielordner `dist/MediTest-4.0.3/` entfernen
3. `dotnet restore`
...
```text
dist/MediTest-4.0.3/windows/MediTest-Setup-4.0.3-win-x64.msi
dist/MediTest-4.0.3/windows/MediTest-4.0.3-win-x64-portable.zip
dist/MediTest-4.0.3/macos/MediTest-4.0.3-macos-x64-setup.zip
dist/MediTest-4.0.3/macos/MediTest-4.0.3-macos-arm64-setup.zip
dist/MediTest-4.0.3/latest.json
dist/MediTest-4.0.3/SHA256SUMS.txt
```
...
Danach in GitHub einen Release mit dem Tag `v4.0.3` erstellen und folgende Dateien hochladen:
...
```powershell
Get-ChildItem .\dist\MediTest-4.0.3 -Recurse -File |
...
```powershell
Get-FileHash -Algorithm SHA256 .\dist\MediTest-4.0.3\windows\MediTest-Setup-4.0.3-win-x64.msi
```
