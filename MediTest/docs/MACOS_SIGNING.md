...
```bash
pkgutil --check-signature MediTest-Setup-5.0.2-macos-arm64.pkg
xcrun stapler validate MediTest-Setup-5.0.2-macos-arm64.pkg
spctl --assess --type install --verbose=4 MediTest-Setup-5.0.2-macos-arm64.pkg
```
