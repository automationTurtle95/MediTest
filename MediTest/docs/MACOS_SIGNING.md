...
```bash
pkgutil --check-signature MediTest-Setup-4.1.7-macos-arm64.pkg
xcrun stapler validate MediTest-Setup-4.1.7-macos-arm64.pkg
spctl --assess --type install --verbose=4 MediTest-Setup-4.1.7-macos-arm64.pkg
```
