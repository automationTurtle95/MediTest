...
```bash
codesign --verify --strict --verbose=2 MediTest-Setup-5.0.5-macos-arm64.dmg
xcrun stapler validate MediTest-Setup-5.0.5-macos-arm64.dmg
spctl --assess --type open --context context:primary-signature --verbose=4 MediTest-Setup-5.0.5-macos-arm64.dmg
```
